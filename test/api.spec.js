...
describe('Es ruta absoluta', () => {
  it('Deberia debolver que la ruta es obsoluta', () => {
    const result = isPathAbsolute('C:\\Users\\User-Pc\\Desktop\\LABORATORIA_Y11\\DEV004-md-links\\pruebas\\1.md');
    expect(result).toBe(true);
  });
...
describe('Convertir en ruta absoluta', () => {
  it('La ruta se convierete en absoluta', () => {
    ...
    const expected = 'C:\\Users\\User-Pc\\Desktop\\LABORATORIA_Y11\\DEV004-md-links\\pruebas\\1.md';
    ...
    const expected = [
      {
        ...
        file: 'C:\\Users\\User-Pc\\Desktop\\LABORATORIA_Y11\\DEV004-md-links\\pruebas\\1.md',
      },
      {
